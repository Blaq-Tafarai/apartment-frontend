      ...
      <div className="bg-surface p-4 rounded-lg border border-color">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-secondary">{invoice.tenant?.user?.name || 'N/A'} - {invoice.lease?.apartment?.unitNumber || 'N/A'}
            </p>
          </div>
          <Badge
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-color">
              ...
              <span className="text-primary">{invoice.tenant?.user?.name || 'N/A'}</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-color">
              <span className="text-secondary font-medium">Lease:</span>
              <span className="text-primary">{invoice.lease?.rentAmount || 'N/A'}</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-color">
              <span className="text-secondary font-medium">Apartment:</span>
              <span className="text-primary">{invoice.lease?.apartment?.unitNumber || 'N/A'}</span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-color">
              <span className="text-secondary font-medium">Building:</span>
              <span className="text-primary">{invoice.lease?.apartment?.building?.name || 'N/A'}</span>
            </div>
          </div>
        </div>
